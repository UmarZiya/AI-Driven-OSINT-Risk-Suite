...
export function ScanHistory({ onBack, onViewReport }: ScanHistoryProps) {
  ...
  //   { id: 'scan_1709040234567_abc123', target: 'john.doe@example.com', ... },
  //   { id: 'scan_1709033856789_def456', target: 'example.com', ... },
  //   ...
  // ];
  // ───────────────────────────────────────────────────────────────────────────
        ...
        <Card className="border-slate-800 bg-slate-900/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">
              {loading ? 'Loading...' : `${scanHistory.length} scan${scanHistory.length !== 1 ? 's' : ''} performed`}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
